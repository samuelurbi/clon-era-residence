              ...
              <div data-marquee-css="track" className="marquee_track">
                <div data-marquee-css="list" className="marquee_list">
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_33.avif" loading="eager" sizes="(max-width: 2146px) 100vw, 2146px" srcSet="/images/img_clouds_33-p-500.avif 500w, /images/img_clouds_33.avif 2146w" alt="" className="clouds is-33" />
                  </div>
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_33.avif" loading="eager" sizes="(max-width: 2146px) 100vw, 2146px" srcSet="/images/img_clouds_33-p-500.avif 500w, /images/img_clouds_33.avif 2146w" alt="" className="clouds is-33" />
                  </div>
          ...
          <div className="loc-w_clouds">
            <div data-marquee-css="" className="marquee">
              <div data-marquee-css="track" className="marquee_track">
                <div data-marquee-css="list" className="marquee_list">
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_47.avif" loading="eager" alt="" className="clouds is-47" />
                  </div>
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_47.avif" loading="eager" alt="" className="clouds is-47" />
                  </div>
          ...
          <div className="loc-w_clouds">
            <div data-marquee-css="" className="marquee">
              <div data-marquee-css="track" className="marquee_track">
                <div data-marquee-css="list" className="marquee_list">
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_02.avif" loading="eager" alt="" className="clouds is-02" />
                  </div>
                  <div className="marquee_list_item">
                    <img src="/images/img_clouds_02.avif" loading="eager" alt="" className="clouds is-02" />
                  </div>
