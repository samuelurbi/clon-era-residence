                        ...
                        <div className="apart-type-slide_img-w">
                          <div className="apart-type-slide_img">
                            <div data-scroll-reveal="slide" data-slider="img" className="img-w">
                              <img src="/images/villa-coson-hero.webp" loading="eager" alt="" sizes="100vw" srcSet="/images/villa-coson-hero-p-500.webp 500w, /images/villa-coson-hero-p-800.webp 800w, /images/villa-coson-hero-p-1080.webp 1080w, /images/villa-coson-hero-p-1600.webp 1600w, /images/villa-coson-hero-p-2000.webp 2000w, /images/villa-coson-hero.webp 2350w" className="img" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div data-reveal-first="" data-slider="slide" role="listitem" className="apart-type-cms_list_item w-dyn-item">
                      <div className="apart-type-slide">
                        ...
                        <div className="apart-type-slide_img-w">
                          <div className="apart-type-slide_img">
                            <div data-scroll-reveal="slide" data-slider="img" className="img-w">
                              <img src="/images/villa-remanso-hero.webp" loading="eager" alt="" sizes="100vw" srcSet="/images/villa-remanso-hero-p-500.webp 500w, /images/villa-remanso-hero-p-800.webp 800w, /images/villa-remanso-hero-p-1080.webp 1080w, /images/villa-remanso-hero-p-1600.webp 1600w, /images/villa-remanso-hero-p-2000.webp 2000w, /images/villa-remanso-hero.webp 2350w" className="img" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div data-reveal-first="" data-slider="slide" role="listitem" className="apart-type-cms_list_item w-dyn-item">
                      <div className="apart-type-slide">
                        ...
                        <div className="apart-type-slide_img-w">
                          <div className="apart-type-slide_img">
                            <div data-scroll-reveal="slide" data-slider="img" className="img-w">
                              <img src="/images/villa-carolina-hero.webp" loading="eager" alt="" sizes="100vw" srcSet="/images/villa-carolina-hero-p-500.webp 500w, /images/villa-carolina-hero-p-800.webp 800w, /images/villa-carolina-hero-p-1080.webp 1080w, /images/villa-carolina-hero-p-1600.webp 1600w, /images/villa-carolina-hero-p-2000.webp 2000w, /images/villa-carolina-hero.webp 2350w" className="img" />
                            </div>
                          </div>
                        </div>
                      </div>
