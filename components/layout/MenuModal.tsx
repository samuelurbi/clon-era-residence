          ...
          <div className="modal_menu_c">
            <div className="grid">
              <div className="modal_menu_list">
                ...
                <a data-part="ctn" aria-label="Select an Apartment" hover-link="" data-modal-close="mob" href="/apartments" className="link w-inline-block">
                  <div className="link_label">
                    <div className="link_label_text"><div hover="text" className="h6">Select an Apartment</div></div>
                    <div className="link_label_text is-2"><div hover="text" className="h6">Select an Apartment</div></div>
                  </div>
                </a>
